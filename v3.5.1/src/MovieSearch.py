...
class MovieSearch():
    def __init__(self):
        ...
        self.last_result = -1
        self.__timer = eTimer()
        self.__timer_conn = self.__timer.timeout.connect(self.__timeout)
        self.__timer_reload = eTimer()
        self.__timer_reload_conn = self.__timer_reload.timeout.connect(self.__timeout_reload)
    ...
    def __onClose(self):
        ...
        self.__timer_reload = None
        self.__timer_reload_conn = None
