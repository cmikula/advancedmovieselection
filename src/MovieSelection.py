    ...
    def delete(self):
        ...
        if self.service.flags & eServiceReference.mustDescent:
            ...
            if config.AdvancedMovieSelection.pincode.value == 'aaaa':
                ...
                return
            self.session.openWithCallback(self.__deleteDirectory, PinInputDialog, _("Enter PIN code"), _("The PIN code is required to delete the directory"), self.service.getPath(), config.AdvancedMovieSelection.retries.deletepin, [config.AdvancedMovieSelection.pincode.value])
            return
