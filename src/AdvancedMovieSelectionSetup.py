...
class AdvancedMovieSelectionSetup(ConfigListScreen, Screen):
    ...
    def createSetup(self):
        ...
        self.list.append(getConfigListEntry(_("Use database path selection as marker within database movies:"), config.AdvancedMovieSelection.db_mark, _("If enabled only the database path selections will used as marker otherwise each sub directory will shown as path marker in database view.")))
