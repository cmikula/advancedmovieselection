...
__dummy1__ = (_("Nothing"), _("Delete"), _("Wastebasket"), _("Sort"), _("Home"), _("Bookmark 1"), _("Bookmark 2"), _("Bookmark 3"), _("Bookmark(s) on/off"), _("Filter by Tags"), _("Tag Editor"), _("Move-Copy"), _("Rename"), _("TMDb search & D/L"), _("Mark as seen"), _("Mark as unseen"), _("Trailer search"))
...
class AdvancedMovieSelectionButtonSetup(Screen, ConfigListScreen):
    def __init__(self, session, csel=None):
        ...
        if YTTrailerPresent == True:
            self.entryguilist.append(("16", "Trailer search"))
        self.entryguilist2 = []
