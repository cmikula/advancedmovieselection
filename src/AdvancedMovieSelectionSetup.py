...
class AdvancedMovieSelectionSetup(ConfigListScreen, Screen):
    ...
    def createSetup(self):
        ...
        if config.AdvancedMovieSelection.show_picon.value:
            self.list.append(getConfigListEntry(_("Show Provider Logo in original size:"), config.AdvancedMovieSelection.piconsize, _("Displays the Provider Logo in original size. Otherwise, the provider logo be displayed zoomed and centered.")))    
...
class AdvancedMovieSelectionButtonSetup(Screen, ConfigListScreen):
    def __init__(self, session, csel=None):
        ...
        self.entryguilist.append(("2", _("Sort")))
        self.entryguilist.append(("3", _("Home")))
        self.entryguilist.append(("4", _("Bookmark 1")))
        self.entryguilist.append(("5", _("Bookmark 2")))
        self.entryguilist.append(("6", _("Bookmark 3")))
        self.entryguilist.append(("7", _("Bookmark(s) on/off")))
        self.entryguilist.append(("8", _("Filter by Tags")))
        self.entryguilist.append(("9", _("Tag Editor")))
        self.entryguilist.append(("10", _("Move-Copy")))
        self.entryguilist.append(("11", _("Rename")))
        self.entryguilist.append(("12", _("TMDb search & D/L")))
        self.entryguilist.append(("13", _("Mark as seen")))
        self.entryguilist.append(("14", _("Mark as unseen")))
        self.entryguilist.append(("15", _("Show new icon")))
        if YTTrailerPresent == True:
            self.entryguilist.append(("16", _("Trailer search")))
        self.entryguilist2 = []
